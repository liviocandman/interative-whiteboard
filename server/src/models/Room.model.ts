...
export class RoomModel {
  ...
  static async createRoomWithId(roomId: string, data: CreateRoomRequest, createdBy: { id: string, name: string }): Promise<Room> {
    const room: Room = {
      id: roomId, // Use provided ID instead of generating
      name: data.name,
      description: data.description || '',
      isPublic: data.isPublic,
      hasPassword: Boolean(data.password),
